...
public class HighTouchPollingService extends Service {
    ...
    private static final String SETTING_KEY = "high_touch_polling_rate_enable";
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(
            LineageSettings.System.getUriFor(LineageSettings.System.HIGH_TOUCH_POLLING_RATE_ENABLE),
    ...
    private void updateTouchPollingState(boolean readSetting) {
        if (readSetting) {
            mEnabled = LineageSettings.System.getInt(getContentResolver(), LineageSettings.System.HIGH_TOUCH_POLLING_RATE_ENABLE, 0) == 1;
        }
